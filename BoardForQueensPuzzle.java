...
public class BoardForQueensPuzzle {
    public int lastRankFilled;  /* the highest-numbered rank    //these should be private I think, but its very late and I was unsure as to how to work around the coding of that.
      that holds a queen. */
